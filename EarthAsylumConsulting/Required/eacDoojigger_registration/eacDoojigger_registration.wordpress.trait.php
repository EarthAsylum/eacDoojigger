 ...
 *
 * uses common code from eacDoojigger_registration_interface trait
 *
...
trait eacDoojigger_registration_wordpress
{
	use eacDoojigger_registration_interface;
	 ...
	 * add_action( 'eacDoojigger_registry_refresh', array($this, 'refreshRegistration') ); // passes registry_key
